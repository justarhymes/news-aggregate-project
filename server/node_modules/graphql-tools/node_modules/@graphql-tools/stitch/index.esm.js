    ...
    Object.keys(typeCandidates).forEach(typeName => {
        if (isObjectType(typeCandidates[typeName][0].type)) {
            ...
            if (mergeTypes === true ||
                ...
                mergedTypeCandidates.forEach(typeCandidate => {
                    ...
                    if (!mergedTypeConfig.resolve) {
                        if (mergedTypeConfig.key != null) {
                            const batchDelegateToSubschema = createBatchDelegateFn(mergedTypeConfig.args, ({ schema, selectionSet, context, info }) => ({
                                schema,
                                operation: 'query',
                            ...
                            mergedTypeConfig.resolve = (originalResult, context, info, subschema, selectionSet) => batchDelegateToSubschema({
                ...
                const targetSubschemas = new Map();
