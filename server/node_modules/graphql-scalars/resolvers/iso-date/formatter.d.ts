...
export declare const serializeDateTime: (dateTime: Date) => string;
export declare const serializeDateTimeString: (dateTime: string) => string;
export declare const serializeUnixTimestamp: (timestamp: number) => string;
